                            ...
                            <div class='card-header'>
                                <div class="row">
                                    <div class='col-6'>
                                        ...
                                        <input type="search" placeholder="Hardware Number" id="search_eq_number" class='form-control search_user' value="12312">
                                    </div>
                                    <div class='col-6'>
                                        <label for="search_user">Hardware Serial Number: </label>
                                        <input type="search" placeholder="Hardware Serial Number" id="search_eq_serial" class='form-control search_user' value="125215212">
                                    </div>
                                </div>
                            </div>
                            <div class='card-body'>
