...
<head>
    <title>M&M's Karczma - Upload Invoice</title>
    <meta charset="utf-8" />
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
                        <h1 class="h3 mb-0 text-gray-800">Upload Invoice</h1>
                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="p-5">
                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 mb-4">Upload Invoice Form</h1>
                                            </div>
                                            <form class="UploadInvoice">
                                                <div class="form-group">
                                                    <label for="UploadInvoice">Pick file to Upload and click <strong>Upload</strong></label>
