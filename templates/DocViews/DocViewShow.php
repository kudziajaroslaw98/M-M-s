...
class DocViewShow
{
    ...
    private static function renderRow(Document &$document)
    {
        ...
        echo '
            <a href="/M-M-s/data/documents/' . $fileName . '" target="_blank">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col mr-2">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <button type="button" id="DocEdit" class="btn btn-primary btn-sm mt-2"><i class="far fa-edit"></i></button>
                                        <button type="button" id="DocDelete" class="btn btn-primary btn-sm mt-2" onclick="deletingRecords('.$id.')"><i class="fas fa-trash"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
