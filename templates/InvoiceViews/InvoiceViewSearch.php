        ...
        try {
            ...
            if (!empty($_POST)) {
                if (in_array($option, array_keys($_POST))) {
                    ...
                    if (!is_numeric($dataForm->data['dob-year'])) {
                        throw new InvalidInputExcetion('Given year is not number!');
                    }
                    if (!is_numeric($dataForm->data['dob-month'])) {
                        throw new InvalidInputExcetion('Given month is not number!');
                    }
