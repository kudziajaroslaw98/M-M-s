...
CREATE TABLE PurchaseInvoices (purchaseInvoiceID int(10) NOT NULL AUTO_INCREMENT, uploadTime timestamp NOT NULL default CURRENT_TIMESTAMP, lastModificationTime timestamp NOT NULL default CURRENT_TIMESTAMP, contractorData varchar(255) NOT NULL, amountNetto float NOT NULL, amountBrutto float NOT NULL, transactionDate date NOT NULL, notes varchar(255), reportID int(10) NOT NULL, filePath varchar(255) NOT NULL UNIQUE, currency varchar(255) NOT NULL, vat float NOT NULL, PRIMARY KEY (purchaseInvoiceID));
...
CREATE TABLE SaleInvoices (saleInvoiceID int(10) NOT NULL AUTO_INCREMENT, uploadTime timestamp NOT NULL default CURRENT_TIMESTAMP, lastModificationTime timestamp NOT NULL default CURRENT_TIMESTAMP, contractorData varchar(255) NOT NULL, amountNetto float NOT NULL, amountBrutto float NOT NULL, transactionDate date NOT NULL, notes varchar(255), reportID int(10) NOT NULL, filePath varchar(255) NOT NULL UNIQUE, currency varchar(255) NOT NULL, vat float NOT NULL, PRIMARY KEY (saleInvoiceID));
