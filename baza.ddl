CREATE TABLE Documents (documentID int(10) NOT NULL, uploadTime timestamp NOT NULL CURRENT_TIMESTAMP, lastModifactionTime timestamp NOT NULL CURRENT_TIMESTAMP, notes varchar(255), ReportsreportID int(10) NOT NULL, PRIMARY KEY (documentID));
...
CREATE TABLE PurchaseInvoices (purchaseInvoiceID int(10) NOT NULL, uploadTime timestamp NOT NULL CURRENT_TIMESTAMP, lastModificationTime timestamp NOT NULL CURRENT_TIMESTAMP, amount float NOT NULL, transactionDate date NOT NULL, notes varchar(255), ReportsreportID int(10) NOT NULL, PRIMARY KEY (purchaseInvoiceID));
...
CREATE TABLE SaleInvoices (saleInvoiceID int(10) NOT NULL, uploadTime timestamp NOT NULL CURRENT_TIMESTAMP, lastModificationTime timestamp NOT NULL CURRENT_TIMESTAMP, amount float NOT NULL, transactionDate date NOT NULL, notes varchar(255), reportID int(10) NOT NULL, PRIMARY KEY (saleInvoiceID));
